 ...
 */
class Version20180611095919 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, grupo_id INT DEFAULT NULL, nombre_categoria VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, aprobada TINYINT(1) NOT NULL, fecha_aceptacion DATE NOT NULL, UNIQUE INDEX UNIQ_4E10122D9C833003 (grupo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE grupos (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, nombre_admin VARCHAR(255) NOT NULL, fecha_creacion DATE NOT NULL, descripcion VARCHAR(255) NOT NULL, total_miembros INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gestiona (id_usuario_id INT NOT NULL, id_categoria_id INT NOT NULL, numero_cambios INT NOT NULL, ultima_modificacion DATE NOT NULL, observaciones VARCHAR(255) NOT NULL, INDEX IDX_23080F9A7EB2C349 (id_usuario_id), INDEX IDX_23080F9A10560508 (id_categoria_id), PRIMARY KEY(id_usuario_id, id_categoria_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE enlace ADD autor_id INT NOT NULL, ADD categoria_enlace_id INT DEFAULT NULL, DROP autor');
        ...
        $this->addSql('CREATE INDEX IDX_8414B27914D45BBE ON enlace (autor_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_8414B27914D45BBE ON enlace');
        $this->addSql('DROP INDEX IDX_8414B279ECCEF2A9 ON enlace');
        $this->addSql('ALTER TABLE enlace ADD autor VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP autor_id, DROP categoria_enlace_id');
    }
}
